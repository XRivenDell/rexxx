...
class CommCrash(SimCrash):
    ...
    def __init__(self, target, crash=None, pov_file=None, actions=None,
        ...
        # HACK: Maybe we can use qiling framework
        ...
        # TODO: POV Testing should generate more povs for input
        ...
        # REVIEW: do choice tracer for vulnerability traceing
    ...
    def concrete_trace(self):
        ...
        for i in range(len(self.actions)-1, -1, -1):
            ...
            if type(act) == RexSendAction:
                ...
                break
        taint = taint[:0x100]
        # FIXME: we disable communication fd analysis for now 
        # because of issues with shellphish-qemu releases
        taint = None
    ...
    def is_armel(self):
        """
        Are we working on a armel binary?
        """
        return self.target.target_os == 'armel'
...
class Crash(CommCrash):
    ...
    def _prepare_exploit_factory(self, blacklist_symbolic_explore=True, **kwargs):
        ...
        if self.input_type == CrashInputType.TCP:
            ...
            if open_fds:
                ...
                # TODO: change these and parameterize them in global config file
    ...
    def _initialize(self):
        ...
        :return:    None
        """
        # HACK: concreate tracing do what?
        # concrete tracing for coredump file?
        self.concrete_trace()
        self.create_project()
